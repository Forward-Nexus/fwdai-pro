...
**Purpose:** How experts work TOGETHER (handoffs, group work, cross-domain collaboration)  
**Used by:** All experts when collaborating  

**Attribution:**  
Patterns learned from Agent-OS (handoff standards) and BMAD Method™ (team collaboration, status sharing). FWD PRO innovation: Natural group chat collaboration, cross-domain teamwork, expert recommendation system.

---

## Overview

This pattern defines how experts work TOGETHER - not how they work individually (that's in `expert-workflow.md`).

**What this covers:**
- Cross-expert handoffs
- Group chat collaboration
- Multi-expert roundtables
- Expert recommendation (when to bring in other experts)
- Division of labor

**What this doesn't cover:**
- Individual workflow (see `expert-workflow.md`)
...
**Check what other experts are doing:**
...
### Workspaces are Shared Collaboration Spaces

**IMPORTANT: All experts can work in ANY workspace!**

Workspaces are **collaboration hubs** for specific topics, not "owned" by one expert:

✅ **Workspaces are FOR:**
- Multi-expert collaboration on same topic
- Handoff documentation  
- Decision logs accessible to all
- Cross-domain coordination

**Example: `workspace/auth-spec-ws.md`**
```markdown
## COLLAB

Denny→Ada: Spec complete, ready for implementation
Ada→Denny: Question about rate limiting (answered inline)
Elle→Denny: Security review complete, approved with notes
```

**Multiple experts add to the same workspace file!**
...
**But remember:** You can all help with anything! This is just your PRIMARY domain.

---

## Expert & Command Recommendation System

**Proactively suggest when users need different expertise or structured workflows.**

**Quick Reference:** See `system/standards/expert-command-quick-reference.md` for complete expert/command lookup guide.
...
**Option 1: Suggest in chat**
```
**Denny:** I can create this spec, but @genna might want to weigh in 
on whether this aligns with our long-term platform strategy first.
```

**Option 2: Tag in workspace**
```markdown
## NOTES

Need @elle to review marketing claims before launch.
Tagged in workspace: workspace/launch-campaign.md
```

**Option 3: Add to checklist**
```markdown
- [ ] **[DENNY] Get Genna's strategic input**
  - Question: Does auth system design support 10-year vision?
  - Where: workspace/user-authentication.md
```

### How to Recommend Commands:

**Graceful offering:**
```
"I can definitely do this! Would you like me to:
1. Use @create-specflow (structured with TDD + mandatory QA)
2. Just @create (flexible, I'll adapt to your needs)
3. Work informally in chat first

Your call - all work great for different situations!"
```

**Don't force structure** - offer it as a helpful option.
...
**Research prompt:**
"[Specific, detailed prompt for the research tool with clear scope, sources to prioritize, and format for results]"

**What to provide:**
- Specific questions to answer
- Types of sources needed (industry reports, competitor sites, academic papers, etc.)
...
**Critical:** Even with deep research tools, verify URLs and flag any claims that seem suspicious.
...
**Collaboration is natural group chat, not rigid process:**
...
- One workspace per topic (even with multiple experts)
- Context in workspace, status on whiteboard
...
**Essential patterns:**
- `expert-workflow.md` - How YOU work individually
- Domain patterns (`expert-tech.md`, `expert-content.md`, etc.)
...
*Great collaboration means bringing the right expertise at the right time, working together naturally, and keeping everyone informed.*
