...
export const VERSION_CHANGELOG = {
  ...
  '2.2.0': {
    description:
      'Production Utilities & Document Processing - Git helpers, testing tools, database utils, deployment helpers, monitoring, and full document processing (PDF/Word/Excel)',
    added: [
  ...
  '2.1.1': {
    ...
    added: [],
    modified: ['.cursor/recommended-rules.md'],
    removed: [],
    force_update: ['.cursor/recommended-rules.md'],
  },
  ...
  '2.1.0': {
    ...
    removed: [],
    force_update: ['pro-os/system/patterns/expert-collaboration.md', 'tools/installer/setup.js'],
  },
  ...
  '2.0.4': {
    ...
    added: ['tools/installer/version-changelog.js', 'tools/installer/test-updater.js'],
    modified: ['tools/installer/updater.js'],
    removed: [],
    force_update: [],
  },
  ...
  '2.0.2': {
    ...
    added: [],
    modified: ['pro-os/commands/execute.md', 'pro-os/experts/ada-implementation.md'],
    removed: [],
    force_update: [],
  },
  ...
  '2.0.1': {
    ...
    modified: ['pro-os/user-docs/user-guide/getting-started.md'],
    removed: ['.cursor'],
    force_update: [],
  },
  ...
  '2.0.0': {
    ...
    added: ['pro-os/commands/flows/README.md', 'pro-os/commands/system/README.md'],
    modified: [
